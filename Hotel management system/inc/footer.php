    ...
    <div class="row">
        <div class="col-lg-4 p-4">
          ...
          <p>
            ...
            Molestias debitis saepe et? Illo mollitia libero sunt, 
            quae veritatis magnam fugiat ipsa nesciunt sed, ea amet dolorem, 
            modi vitae aspernatur aliquam?
          </p>
        </div>
        <div class="col-lg-4 p-4">
...
<h6 class="text-center bg-dark text-white p-3 m-0">Designed and Developed by JK</h6>
     ...
     let xhr = new XMLHttpRequest();
        ...
        xhr.onload = function(){
          if(this.responseText == 'pass_mismatch'){
            ...
            alert('error',"Only JPG, WEBO $ PNG IMAAGES ARE ALLOWED!");
          }
